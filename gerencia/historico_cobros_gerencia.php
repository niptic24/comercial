...
$stmtp = $conn->prepare("SELECT SUM(`presupuesto`)  as totalg FROM cobros_gen WHERE `asesor`= ? ");
$stmtp->execute([$_SESSION['asesor'] ]);
$rowp = $stmtp->fetch(PDO::FETCH_ASSOC);
$presupuesto_cobro_global_historicoc = $rowp['totalg'];

//Obtener valor venta mensual
$stmt1 = $conn->prepare("SELECT SUM(`cobro`)  as totalg FROM cobros_gen WHERE asesor= ? and ano=? and mes= ? ");
$stmt1->execute([$_SESSION['asesor'] , $ano, $mesh ]);
$row1 = $stmt1->fetch(PDO::FETCH_ASSOC);
$cobro_mensual_historico_c = $row1['totalg']; 

//Obtener valor presupuesto mensual
$stmt1 = $conn->prepare("SELECT SUM(`presupuesto`)  as totalg FROM cobros_gen WHERE asesor= ? and ano=? and mes= ? ");
$stmt1->execute([$_SESSION['asesor'] ,$ano, $mesh ]);
$row1 = $stmt1->fetch(PDO::FETCH_ASSOC);
$cobro_presupuesto_mensual_historico_c = $row1['totalg']; 

 //Semaforizacionón
 $porcentajeventabarra = 0;
 if($cobro_mensual_historico_c != 0 and $cobro_presupuesto_mensual_historico_c!= 0 ){
   $porcentajeventabarra= round( $cobro_mensual_historico_c / $cobro_presupuesto_mensual_historico_c * 100);
 }
...
$porcentaje1=$cobro_presupuesto_mensual_historico_c*70/100;
$porcentaje2=$cobro_presupuesto_mensual_historico_c*95/100;
$porcentaje3=$cobro_presupuesto_mensual_historico_c*100/100;            
$respuesta = "";
$textom = "";  

if ($cobro_mensual_historico_c < $porcentaje3 ) {
$respuesta = $porcentaje3 - $cobro_mensual_historico_c; 
$textom = "<font color=\"red\">Falta $".$respuesta." para llegar al valor del presupuesto mensual.</font>";
} else if ($cobro_mensual_historico_c >= $porcentaje3) {
  $respuesta = $cobro_mensual_historico_c-$porcentaje3; 
$textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
 ...
 if($cobro_global_historicoc != 0 and $cobro_presupuesto_mensual_historico_c!= 0 ){
   $porcentajeventabarrag= round( $cobro_global_historicoc / $cobro_presupuesto_mensual_historico_c* 100);
 }
$porcentajeg1=$cobro_presupuesto_mensual_historico_c*70/100;
$porcentajeg2=$cobro_presupuesto_mensual_historico_c*95/100;
$porcentajeg3=$cobro_presupuesto_mensual_historico_c*100/100;            
$respuestag = "";
$textog = "";  

if ($cobro_global_historicoc < $porcentajeg3 ) {
 $respuestag = $porcentajeg3 - $cobro_global_historicoc; 
 $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
 } else if ($cobro_global_historicoc >= $porcentajeg3) {
   $respuestag = $cobro_global_historicoc-$porcentajeg3; 
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Histórico Cobros - Mes <?php 
    ...
    ?>  </h1>
                    ...
                    <p>Mes &nbsp &nbsp &nbsp &nbsp &nbsp Año &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Linea</p>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total de presupuesto cobros ENE - <?php echo date('M'), ' del ' , date("Y") ?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php if( isset($_POST['submit']) ){	echo "$".$presupuesto_cobro_global_historicoc ;}
                                                else echo "$0"?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <?php if( isset($_POST['submit']) ){	echo "$".$cobro_mensual_historico_c ;}
                                                else echo "$0"?>
                                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php if( isset($_POST['submit']) ){	echo "$".$cobro_presupuesto_mensual_historico_c ;}
                                                else echo "$0"?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
...
<div class="progress">
    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated "
        role="progressbar" style="width: <?php echo $porcentajeventabarra ?>%;"
        aria-valuenow=" <?php echo $porcentajeventabarra ?>" aria-valuemin="0"
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $cobro_mensual_historico_c ?>,<?php echo $cobro_presupuesto_mensual_historico_c?>],

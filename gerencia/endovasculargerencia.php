...
$presupuesto_global_endog = $rowp['totalgp'];
...
$statement = $conn->prepare("SELECT  mes,venta FROM `endo` WHERE `asesor`=? and `ano` =?");
...
//mes año actual
$statement1 = $conn->prepare("SELECT mes, venta FROM `endo` WHERE `asesor`=? and `ano` =?");
...
$venta_mensual_endog = $row1['totalm']; 
...
$presupuesto_mensua_endog = $rowp1['totalpm']; 
...
$data1 = trim($data1,",");
  ...
  if($venta_mensual_endog != 0 and $presupuesto_mensua_endog!= 0 ){
    $porcentajeventabarra= round( $venta_mensual_endog / $presupuesto_mensua_endog * 100);
  }
$porcentaje1=$presupuesto_mensua_endog*70/100;
$porcentaje2=$presupuesto_mensua_endog*95/100;
$porcentaje3=$presupuesto_mensua_endog*100/100;            
$respuesta = "";
$textom = "";  
 
if ($venta_mensual_endog < $porcentaje3 ) {
 $respuesta = $porcentaje3 - $venta_mensual_endog; 
 $textom = "<font color=\"red\">Falta $".$respuesta." para llegar al valor del presupuesto mensual.</font>";
 } else if ($venta_mensual_endog >= $porcentaje3) {
   $respuesta = $venta_mensual_endog-$porcentaje3; 
 $textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
  ...
  if($venta_global_endog != 0 and $presupuesto_global_endog!= 0 ){
    $porcentajeventabarrag= round( $venta_global_endog / $presupuesto_global_endog* 100);
  }
$porcentajeg1=$presupuesto_global_endog*70/100;
$porcentajeg2=$presupuesto_global_endog*95/100;
$porcentajeg3=$presupuesto_global_endog*100/100;            
$respuestag = "";
$textog = "";  
 
if ($venta_global_endog < $porcentajeg3 ) {
  $respuestag = $porcentajeg3 - $venta_global_endog; 
  $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
  } else if ($venta_global_endog >= $porcentajeg3) {
    $respuestag = $venta_global_endog-$porcentajeg3; 
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php	echo "$".$presupuesto_global_endog ;  ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php 	echo "$".$venta_mensual_endog ?></div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo "$".$presupuesto_mensua_endog ;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $venta_mensual_endog ?>,<?php echo $presupuesto_mensua_endog?>],
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $venta_global_endog ?>,<?php echo $presupuesto_global_endog ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],

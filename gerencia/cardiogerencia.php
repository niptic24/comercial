...
$venta_global_cardio_g = $row['totalg'];
...
$presupuesto_global_cardiog = $rowp['totalgp'];
...
$statement = $conn->prepare("SELECT  mes,venta FROM `cardio` WHERE `asesor`=? and `ano` =?");
...
//mes año actual
$statement1 = $conn->prepare("SELECT mes, venta FROM `cardio` WHERE `asesor`=? and `ano` =?");
...
$venta_mensual_cardiog = $row1['totalm']; 
...
$presupuesto_mensual_cardiog = $rowp1['totalpm']; 
...
$data1 = trim($data1,",");
 ...
 if($venta_mensual_cardiog != 0 and $presupuesto_mensual_cardiog!= 0 ){
   $porcentajeventabarra= round( $venta_mensual_cardiog / $presupuesto_mensual_cardiog * 100);
 }
$porcentaje1=$presupuesto_mensual_cardiog*70/100;
$porcentaje2=$presupuesto_mensual_cardiog*95/100;
$porcentaje3=$presupuesto_mensual_cardiog*100/100;            
$respuesta = "";
$textom = "";  

if ($venta_mensual_cardiog < $porcentaje3 ) {
$respuesta = $porcentaje3 - $venta_mensual_cardiog; 
$textom = "<font color=\"red\">Falta $".$respuesta." para llegar al valor del presupuesto mensual.</font>";
} else if ($venta_mensual_cardiog >= $porcentaje3) {
  $respuesta = $venta_mensual_cardiog-$porcentaje3; 
$textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
 ...
 if($venta_global_cardio_g != 0 and $presupuesto_global_cardiog!= 0 ){
   $porcentajeventabarrag= round( $venta_global_cardio_g / $presupuesto_global_cardiog* 100);
 }
$porcentajeg1=$presupuesto_global_cardiog*70/100;
$porcentajeg2=$presupuesto_global_cardiog*95/100;
$porcentajeg3=$presupuesto_global_cardiog*100/100;            
$respuestag = "";
$textog = "";  

if ($venta_global_cardio_g < $porcentajeg3 ) {
 $respuestag = $porcentajeg3 - $venta_global_cardio_g; 
 $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
 } else if ($venta_global_cardio_g >= $porcentajeg3) {
   $respuestag = $venta_global_cardio_g-$porcentajeg3; 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Linea Cardio Pulmonar </h1>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php	echo "$".$venta_global_cardio_g ;?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php	echo "$".$presupuesto_global_cardiog ;  ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php 	echo "$".$venta_mensual_cardiog ?></div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo "$".$presupuesto_mensual_cardiog ;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $venta_mensual_cardiog ?>,<?php echo $presupuesto_mensual_cardiog?>],
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $venta_global_cardio_g ?>,<?php echo $presupuesto_global_cardiog ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],

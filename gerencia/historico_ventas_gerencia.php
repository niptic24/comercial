...
$venta_global_historicoc = $row['totalg'];
...
$presupuesto_venta_global_historicoc = $rowp['totalg'];
...
$stmt1->execute([$_SESSION['asesor'] ,$ano, $mesh ]);
$row1 = $stmt1->fetch(PDO::FETCH_ASSOC);
$venta_presupuesto_mensual_historico_c = $row1['totalg']; 

  //Semaforizacionón mensual

  $porcentajeventabarra = 0;
  if($venta_mensual_historico_c != 0 and $venta_presupuesto_mensual_historico_c!= 0 ){
    $porcentajeventabarra= round( $venta_mensual_historico_c / $venta_presupuesto_mensual_historico_c * 100);
  }
$porcentaje1=$venta_presupuesto_mensual_historico_c*70/100;
$porcentaje2=$venta_presupuesto_mensual_historico_c*95/100;
$porcentaje3=$venta_presupuesto_mensual_historico_c*100/100;            
$respuesta = "";
$textom = "";  
...
if ($venta_mensual_historico_c < $porcentaje3 ) {
 ...
 $textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
  ...
  if($venta_global_historicoc != 0 and $presupuesto_venta_global_historicoc!= 0 ){
    $porcentajeventabarrag= round( $venta_global_historicoc / $presupuesto_venta_global_historicoc* 100);
  }
$porcentajeg1=$presupuesto_venta_global_historicoc*70/100;
$porcentajeg2=$presupuesto_venta_global_historicoc*95/100;
$porcentajeg3=$presupuesto_venta_global_historicoc*100/100;            
$respuestag = "";
$textog = "";  
 
if ($venta_global_historicoc < $porcentajeg3 ) {
  $respuestag = $porcentajeg3 - $venta_global_historicoc; 
  $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
  } else if ($venta_global_historicoc >= $porcentajeg3) {
    $respuestag = $venta_global_historicoc-$porcentajeg3; 
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $venta_mensual_historico_c ?>,<?php echo $venta_presupuesto_mensual_historico_c?>],
 ...
 <?php } 
     ...
     ?>
     <h5>Ene - <?php echo date('M'), ' del ' , $ano?></h5>
   <script>// Set new default font family and font color to mimic Bootstrap's default styling
Chart.defaults.global.defaultFontFamily = 'Nunito', '-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif';
Chart.defaults.global.defaultFontColor = '#858796';
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $venta_global_historicoc ?>,<?php echo $presupuesto_venta_global_historicoc ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],

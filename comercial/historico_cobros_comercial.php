...
$statement = $conn->prepare("SELECT * FROM cobros_gen  WHERE asesor = ? and ano = ? GROUP BY mes = ? ASC; ");
...
if ($cobro_mensual_historico_c < $porcentaje3 ) {
 ...
 $textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
  ...
  if($cobro_global_historicoc != 0 and $presupuesto_cobro_global_historicoc!= 0 ){
    $porcentajeventabarrag= round( $cobro_global_historicoc / $presupuesto_cobro_global_historicoc* 100);
  }
$porcentajeg1=$presupuesto_cobro_global_historicoc*70/100;
$porcentajeg2=$presupuesto_cobro_global_historicoc*95/100;
$porcentajeg3=$presupuesto_cobro_global_historicoc*100/100;            
$respuestag = "";
$textog = "";  
...
<body id="page-top">
               ...
               <?php  include 'nav_comercial.php' ?>
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Histórico Cobros- <?php 
                         if ($grafica == 'm') {
                            echo "Mensual ";
                        }
                        else if ($grafica == 'g'){
    ...
    ?></h1>
                    ...
                    <!-- Content Row -->
                      ...
                      <p>Mes   &nbsp  &nbsp &nbsp   &nbsp &nbsp  Año   &nbsp&nbsp    &nbsp &nbsp &nbsp &nbsp &nbsp </p>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Presupuesto del cobros <?php echo date('M'), ' del ' , date("Y") ?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary"> <?php echo date('M'), ' del ' , date("Y") ?>
                                    </h6>
                                    <div class="dropdown no-arrow">
                                        <!--
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $cobro_global_historicoc ?>,<?php echo $presupuesto_cobro_global_historicoc ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],

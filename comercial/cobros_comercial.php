...
$venta_global_cobroc = $row['totalg'];
...
$presupuesto_global_cobroc = $rowp['totalgp'];
...
$cobro_mensual_comercial =$row1['totalm']; 
...
$presupuesto_cobro_comercial = $rowp1['totalpm']; 
...
$data1 = trim($data1,",");
   ...
   if($cobro_mensual_comercial != 0 and $presupuesto_cobro_comercial!= 0 ){
     $porcentajeventabarra= round( $cobro_mensual_comercial / $presupuesto_cobro_comercial * 100);
   }
 $porcentaje1=$presupuesto_cobro_comercial*70/100;
 $porcentaje2=$presupuesto_cobro_comercial*95/100;
 $porcentaje3=$presupuesto_cobro_comercial*100/100;            
 $respuesta = "";
 $textom = "";  
  
 if ($cobro_mensual_comercial < $porcentaje3 ) {
  $respuesta = $porcentaje3 - $cobro_mensual_comercial; 
  $textom = "<font color=\"red\">Falta $".$respuesta." para llegar al valor del presupuesto mensual.</font>";
  } else if ($cobro_mensual_comercial >= $porcentaje3) {
    $respuesta = $cobro_mensual_comercial-$porcentaje3; 
  $textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
   ...
   if($venta_global_cobroc != 0 and $presupuesto_global_cobroc!= 0 ){
     $porcentajeventabarrag= round( $venta_global_cobroc / $presupuesto_global_cobroc* 100);
   }
 $porcentajeg1=$presupuesto_global_cobroc*70/100;
 $porcentajeg2=$presupuesto_global_cobroc*95/100;
 $porcentajeg3=$presupuesto_global_cobroc*100/100;            
 $respuestag = "";
 $textog = "";  
  
 if ($venta_global_cobroc < $porcentajeg3 ) {
   $respuestag = $porcentajeg3 - $venta_global_cobroc; 
   $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
   } else if ($venta_global_cobroc >= $porcentajeg3) {
     $respuestag = $venta_global_cobroc-$porcentajeg3; 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Reporte Cobros </h1>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Total de Cobros Enero - <?php echo date('M'), ' del ' , date("Y") ?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php	echo "$".$venta_global_cobroc ;?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Total de presupuesto Enero <?php echo date('M'), ' del ' , date("Y") ?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php	echo "$".$presupuesto_global_cobroc ;  ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> Cobro del mes <?php echo date('M'), ' del ' , date("Y") ?>                                        </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php 	echo "$".$cobro_mensual_comercial ?></div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo "$".$presupuesto_cobro_comercial ;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $cobro_mensual_comercial ?>,<?php echo $presupuesto_cobro_comercial?>],
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $venta_global_cobroc ?>,<?php echo $presupuesto_global_cobroc ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],

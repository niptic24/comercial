...
$asesorlinea= $_SESSION['subnombre'];
...
$presupuesto_global_ana_c = $rowp['totalgp'];
...
$venta_mensual_ana_c = $row1['totalm']; 
...
$presupuesto_mensual_ana_c = $rowp1['totalpm']; 
...
$data1 = trim($data1,",");
  ...
  if($venta_mensual_ana_c != 0 and $presupuesto_mensual_ana_c!= 0 ){
    $porcentajeventabarra= round( $venta_mensual_ana_c / $presupuesto_mensual_ana_c * 100);
  }
$porcentaje1=$presupuesto_mensual_ana_c*70/100;
$porcentaje2=$presupuesto_mensual_ana_c*95/100;
$porcentaje3=$presupuesto_mensual_ana_c*100/100;            
$respuesta = "";
$textom = "";  
 
if ($venta_mensual_ana_c < $porcentaje3 ) {
 $respuesta = $porcentaje3 - $venta_mensual_ana_c; 
 $textom = "<font color=\"red\">Falta $".$respuesta." para llegar al valor del presupuesto mensual.</font>";
 } else if ($venta_mensual_ana_c >= $porcentaje3) {
   $respuesta = $venta_mensual_ana_c-$porcentaje3; 
 $textom = "<font color=\"green\">Superaste por $".$respuesta." el valor del presupuesto mensual.</font>";
  ...
  if($venta_global_ana_c != 0 and $presupuesto_global_ana_c!= 0 ){
    $porcentajeventabarrag= round( $venta_global_ana_c / $presupuesto_global_ana_c* 100);
  }
$porcentajeg1=$presupuesto_global_ana_c*70/100;
$porcentajeg2=$presupuesto_global_ana_c*95/100;
$porcentajeg3=$presupuesto_global_ana_c*100/100;            
$respuestag = "";
$textog = "";  
 
if ($venta_global_ana_c < $porcentajeg3 ) {
  $respuestag = $porcentajeg3 - $venta_global_ana_c; 
  $textog = "<font color=\"red\">Falta $".$respuestag." para llegar al valor del presupuesto global.</font>";
  } else if ($venta_global_ana_c >= $porcentajeg3) {
    $respuestag = $venta_global_ana_c-$porcentajeg3; 
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Total de ventas Ene-<?php echo date('M'), ' del ' , $año?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php	echo "$".$venta_global_ana_c ;?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Total de presupuesto Ene-<?php echo date('M'), ' del ' , $año?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php	echo "$".$presupuesto_global_ana_c ;  ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php 	echo "$".$venta_mensual_ana_c ?></div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo "$".$presupuesto_mensual_ana_c ;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Semaforización <?php echo date('M'), ' del ' , $año?></h6>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo $venta_mensual_ana_c ?>,<?php echo $presupuesto_mensual_ana_c ?>],
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: ["Venta", "Presupuesto"],
    datasets: [{
      data: [<?php echo $venta_global_ana_c ?>,<?php echo $presupuesto_global_ana_c ?>],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf'],
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],
